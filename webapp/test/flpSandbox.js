		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample App",
									"targetURL": "#comsapsampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsampleapp-display": {
								"semanticObject": "comsapsampleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.sampleapp",
									"url": sap.ui.require.toUrl("com/sap/sampleapp")
								}
							}
						}
					}
